...
if ( ! class_exists( 'DarkNews_Info' ) ) {
    ...
    class DarkNews_Info {
         ...
         * Single instance.
         *
         * @var DarkNews_Info $instance Instance object.
         */
        ...
        public static function init( $config ) {
            if ( ! isset( self::$instance ) && ! ( self::$instance instanceof DarkNews_Info ) ) {
                self::$instance = new DarkNews_Info;
        ...
        public function configure() {
            ...
            $this->notice        = '<p>' . sprintf( esc_html__( 'Welcome! Thank you for choosing %1$s. To fully take advantage of the best our theme can offer please make sure you visit theme details page.', 'darknews' ), esc_html( $this->theme_name ) ) . '</p><p><a href="' . esc_url( $this->page_url ) . '" class="button button-primary">' . sprintf( esc_html__( 'Get started with %1$s', 'darknews' ), $this->theme_name ) . '</a><a href="#" class="btn-dismiss" data-userid="' . esc_attr( get_current_user_id() ) . '" data-nonce="' . esc_attr( wp_create_nonce( 'darknews_dismiss_nonce' ) ) . '">' . esc_html__( 'Dismiss this notice', 'darknews' ) . '</a></p>';
        }
        ...
        public function hooks() {
            ...
            // Dismiss AJAX.
            add_action( 'wp_ajax_darknews_dismiss', array( $this, 'dismiss_callback' ) );
            add_action( 'wp_ajax_nopriv_darknews_dismiss', array( $this, 'dismiss_callback' ) );
        }
        ...
        public function render_current_tab_content() {
            ...
            if ( method_exists( $this, $method ) ) {
                ...
                printf( esc_html__( '%s() method does not exist.', 'darknews' ), $method );
            }
        }
        ...
        public function useful_plugins() {
            ...
            <div class="aft-section aft-section-useful-plugins">
                ...
                <?php if ( true !== $tgmpa_complete ) : ?>
                    <a href="<?php echo esc_url( $tgmpa_url ); ?>" class="button button-primary"><?php esc_html_e( 'Manage Plugins', 'darknews' ); ?></a>
                <?php endif; ?>
                ...
                <div class="compare-table table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th class="db-bk-color-one"><?php _e('Product Features', 'darknews'); ?></th>
                            <th class="db-bk-color-two"><?php _e('Free', 'darknews'); ?></th>
                            <th class="db-bk-color-two"><?php _e('Premium', 'darknews'); ?></th>
                        </tr>
                        </thead>
                        <tbody>
        ...
        public function assets( $hook ) {
            ...
            if ( in_array( $hook, array( 'themes.php', 'appearance_page_' . $this->page_slug ), true ) ) {
                wp_enqueue_style( 'darknews-info', get_template_directory_uri() . '/lib/info/css/info.css', array(), '1.0.0' );
                wp_enqueue_script( 'darknews-info', get_template_directory_uri() . '/lib/info/js/info' . $min . '.js', array(), '1.0.0' );
            }
        ...
        public function display_admin_notice() {
            ...
            $dismiss_status = get_user_meta( $user_id, 'darknews_dismiss_status', true );
            ?>
        ...
        public function dismiss_callback() {
            ...
            if ( false === wp_verify_nonce( $wpnonce, 'darknews_dismiss_nonce' ) ) {
                wp_send_json( $output );
            }

            update_user_meta( $userid, 'darknews_dismiss_status', 1 );
